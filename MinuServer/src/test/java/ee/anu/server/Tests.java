...
public class Tests {
    ...
    public void testParameterEncoding() throws Exception {
        ...
        RequestHandler handler = new RequestHandler() {
            @Override
            public Response handleRequest(Request request) throws IOException {
                return new Response(Collections.emptyMap(), request.getRequestParametersMap().get("fuzz").getBytes(), Status.OK);
            }
    ...
    public void testFixedBodyEcho() throws Exception {
        ...
        RequestHandler handler = new RequestHandler() {
            @Override
            public Response handleRequest(Request request) throws IOException {
                return new Response(Collections.emptyMap(), request.getRequestData(), Status.OK);
            }
